...
```{r}
#primero establecemos las variables sobre cada uno de los conjuntos de datos que nos piden en el enunciado
df_mammals <- mammals
df_animals2<- Animals2

#Sabemos que:
#Funcion str: obtenemos la estructura de los datos
#Funcion head: vemos los primeros elementos del fichero
#Funcion tail: vemos los ultimos elementos del fichero


#Buscamos las caracteristicas sobre el conjunto mammals:
summarise(df_mammals)
dim(df_mammals)
head(df_mammals)
tail(df_mammals)
str(df_mammals)
#Mostramos los nombres de las filas y columnas:
rownames(df_mammals)
colnames(df_mammals)


#Buscamos las caracteristicas sobre el conjunto Animals2:
summarise(df_animals2)
dim(df_animals2)
head(df_animals2)
tail(df_animals2)
str(df_animals2)
...
commonAnimals <- intersect(df_mammals, df_animals2)
#Nos dice el nombre de cada fila de la variable nueva commonAnimals que son los comunes en ambos dataframes
...
diferentes_mammals <- setdiff(rownames(df_mammals), rownames(df_animals2))
diferentes_mammals
length(diferentes_mammals)
#Los animales que no estan en ambos conjuntos son 4, tomando como referencia df_mammals.
...
diferentes_animales <- setdiff(rownames(df_animals2), rownames(df_mammals))
diferentes_animales
length(diferentes_animales)
#Los animales que no estan en ambos conjuntos son 7, tomando como referencia df_animals2.
...
#Como en ambos casos las muestras estan dentro de las lineas azules discontinuas, podemos indicar que siguen una distribucion Gaussiana con un 95% de confianza ambos conjuntos. Y por tanto, si presentan el mismo comportamiento.
...
#Apartado c:
length(libReturn)#Tengo 3 librerias
...
#Como en ambas representaciones los datos se encuentran dentro de als lineas azules, se puede decir que si que verifican esta condicion.
